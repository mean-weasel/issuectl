...
const DEFAULT_SETTINGS: Setting[] = [
  ...
  { key: "codex_extra_args", value: "--sandbox danger-full-access --ask-for-approval never" },
  ...
  { key: "webhook_raw_payload_retention_days", value: "7" },
  { key: "webhook_event_retention_days", value: "30" },
