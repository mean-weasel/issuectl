#!/usr/bin/env node
// Warm-pass collection — after dev server has compiled each route once.
// Each route is navigated twice; we record the 2nd nav (warm) metrics.
// Between routes we force a blank nav to flush back/forward cache.
